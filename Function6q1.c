...
int main()
{
    ...
    */
    ...
    if ((max_bricks >= max_bricks2) && (max_bricks >= max_bricks3))
        printf("Maximum number of bricks that can fit ist: %d", max_bricks);
    else if ((max_bricks2 >= max_bricks) && (max_bricks2 >= max_bricks3))
        printf("Maximum number of bricks that can fit isu: %d", max_bricks2);
    else
        printf("Maximum number of bricks that can fit isv: %d", max_bricks3);
